...
def main():
    ...
    respond("Hello, Gautam. I hope you're having a nice day today.")
    while True:
        command = listen_for_command()

        # triggerKeyword = "groot"
        #
        # if command and triggerKeyword in command:
        if listeningToTask:
            tasks.append(command)
            listeningToTask = False
            respond("Adding " + command + " to your task list. You have " + str(
                len(tasks)) + " currently in your list.")
